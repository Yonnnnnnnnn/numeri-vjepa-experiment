...
General utility functions for model logging, device management, and metric tracking.
Pattern: Facade

CFG Structure:
═══════════════════════════════════════════════════════════════════════════════
Start Symbol    : GeneralUtils (this script)

Non-Terminals   :
  ┌─ INTERNAL (defined in this file) ─────────────────────────────────────────┐
  │  <Printing>      → slprint | NiceRepr                                     │
  │  <StateDict>     → clean_state_dict                                       │
  │  <Metrics>       → BestMetricSingle | BestMetricHolder | ModelEma         │
  │  <Vision>        → get_expected_points_from_map | renorm                  │
  └───────────────────────────────────────────────────────────────────────────┘

  ┌─ EXTERNAL (imported from other modules) ──────────────────────────────────┐
  │  <torch>         ← from pytorch (Deep Learning framework)                  │
  │  <numpy>         ← from numpy (Numerical processing)                       │
  └───────────────────────────────────────────────────────────────────────────┘

Terminals       : str, int, float, bool, tensor, dict

Production Rules:
  GeneralUtils    → imports + <Printing>+ <StateDict>+ <Metrics>+ <Vision>+
═══════════════════════════════════════════════════════════════════════════════
"""
